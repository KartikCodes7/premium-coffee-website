    ...
    <div className="fixed bottom-6 left-6 z-[9998]">
      <div className="relative">
        ...
        <button
          ...
          className="glass-card p-3 rounded-full flex items-center gap-2 shadow-2xl hover:border-[#E5C158]/50 transition-colors spring-interaction"
        >
          <span className="material-symbols-outlined text-[#E5C158] animate-pulse">tune</span>
        ...
        {isOpen && (
          <>
            ...
            <div className="absolute bottom-full left-0 mb-3 bg-[#12141C] border border-ice-border rounded-xl p-3 shadow-2xl w-56 flex flex-col gap-1 z-[9999]">
              ...
              <button
                ...
                className={`text-left px-3 py-1.5 rounded-lg text-[11px] flex items-center justify-between hover:bg-white/5 text-[#8E939E] ${
                  session.restaurant.includes('London') ? 'text-[#E5C158]' : ''
                }`}
              >
              ...
              <button
                ...
                className={`text-left px-3 py-1.5 rounded-lg text-[11px] flex items-center justify-between hover:bg-white/5 text-[#8E939E] ${
                  session.restaurant.includes('Tokyo') ? 'text-[#E5C158]' : ''
                }`}
              >
